...
#DataFrame by converting categories to columns
...
#single programming language (e.g., java) on a chart. (or reshaped_df['java'])
#figure() - allows to resize our chart
plt.figure(figsize=(16,10))
#add text to the x-axis (Name x)
plt.xlabel('Date', fontsize=14)
#add text to the y-axis (name y)
...
#and move it forward by one overservation. Pandas has two handy methods already built 
#in to work this out: rolling() and mean().
